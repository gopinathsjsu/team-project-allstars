...
export default class TravellerInfo extends Component {
  constructor(props) {
    ...
    this.state = {
      travellers: [],
      count: parseInt(localStorage.getItem("numberOfTraveller")),
      continue: false,
    };
  }
  ...
  onAdd = () => {
    ...
    if (count > 0) {
      ...
      swal(
        "",
        "You have added number of travellers you selected. Please do new search for adding more travellers",
        "warning"
      );
    }
  };
  ...
  render() {
    ...
    let reservationDetails = JSON.parse(
    ...
    if (
      ...
      travellersDetails = <h3>Add a traveller</h3>;
    }
          ...
          <div className="w3-row-padding">
                ...
                <div className="w3-container w3-display-container w3-padding-16">
                  ...
                  <p>
                    <button
                      ...
                      onClick={this.onAdd}
                    >
                      <i className="fa fa-plus w3-margin-right"></i> Add
                    </button>
                  </p>
                </div>
              </div>
            ...
            <div className="w3-twothird">
              ...
              >
                ...
                >
                  Continue <i className="fa fa-arrow-right w3-margin-right"></i>{" "}
                </button>
              </div>
            </div>
          </div>
