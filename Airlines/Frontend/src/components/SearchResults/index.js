...
export default class SearchResults extends Component {
  ...
  onSelect = async (id) => {
    ...
    const numberOfTraveller = parseInt(
      localStorage.getItem("numberOfTraveller")
    );
    ...
    flights.forEach((flight) => {
      if (id === flight._id) {
        const price =
          travelType === "economy"
            ? flight.economySeatPrice * numberOfTraveller
            : flight.businessSeatPrice * numberOfTraveller;
        reservation = {
            ...
            <div className="w3-third">
              <div className="w3-white w3-text-grey w3-card-4">
                <div className="w3-container w3-display-container w3-padding-16">
                  <img src={plane} alt="" style={{ width: "100%" }} />
                  <br />
                  <h2>Update Search</h2>
                  <hr />
                  <form onSubmit={this.onSubmitSearch}>
                    <p>
                      <label>
                        <i className=" fa fa-globe fa-fw"></i> From
                      </label>
                    </p>
                    <input
                    ...
                    <p>
                      <label>
                        <i className="f fa fa-globe fa-fw"></i> To
                      </label>
                    </p>
                    <input
                      className="w3-input w3-border"
                    ...
                    <p>
                      <label>
                        <i className="fa fa-male"></i> Travellers
                      </label>
                    </p>
                    <input
                      className="w3-input w3-border"
                    ...
                    <p>
                      <label>
                        <i className="fa fa-suitcase fa-fw"></i> Booking Type
                      </label>
                    </p>
                    <select
                      className="w3-input w3-border"
                    ...
                    <p>
                      <button
                        ...
                        type="submit"
                      >
                        <i className="fa fa-search w3-margin-right"></i> Update
                      </button>
                    </p>
                  </form>
                </div>
