...
class UpdateFlight extends Component {
  ...
  onSubmitUpdate = (e) => {
    ...
    const updateFlightData = {
      ...
      economySeatPrice:
        this.state.economySeatPrice || this.props.flighData.economySeatPrice,
      businessSeatPrice:
        this.state.businessSeatPrice || this.props.flighData.businessSeatPrice,
      economySeatsCapacity:
        this.state.ecoSeatCap || this.props.flighData.economySeatsCapacity,
      businessSeatsCapacity:
        this.state.busiSeatCap || this.props.flighData.economySeatsCapacity,
    };
                  ...
                  <form onSubmit={this.onSubmitUpdate}>
                    ...
                    <div className="d-flex align-items-center flex-fill me-sm1 my-sm-0 border-bottom position-relative">
                      <input
                        ...
                        className="form-control"
                        onChange={this.onChange}
                        defaultValue={this.props.flighData.economySeatsCapacity}
                      />
                    </div>
                    <div className="d-flex align-items-center flex-fill ms-sm-1 my-sm-0 my-4 border-bottom position-relative">
                      <input
                        ...
                        onChange={this.onChange}
                        defaultValue={
                          this.props.flighData.businessSeatsCapacity
                        }
                      />
                    </div>
